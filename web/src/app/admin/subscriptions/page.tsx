...
export default async function AdminSubscriptionsPage() {
    ...
    // MRR (premium * 15 000 FCFA)
    const mrr = premiumSubs * 15000;
        ...
        <div className="flex flex-col min-h-screen bg-background text-foreground">
            ...
            <header className="h-20 bg-background/80 backdrop-blur border-b border-border flex items-center px-8 shrink-0">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">{all.length} organisations · {premiumSubs} Premium</p>
                </div>
            </header>
            ...
            <div className="p-6 md:p-8 space-y-6">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <StatCard icon={<Crown className="h-5 w-5" />} color="bg-amber-500/10 text-amber-600" label="Premium" value={premiumSubs} sub="15 000 FCFA/mois" />
